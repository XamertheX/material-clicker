...
function setDaily() {
  setVar('materialPerClickBoost', 1);
  setVar('buttonDoublePercentBoost', 0);
  setVar('shopDiscount', 1);
  ...
  if(dayNumber === 1) {
    ...
    AlertDialog(
      'Welcome!',
      `Today is ${day}, and that means you have a higher change of getting Golden
      Clicks.`,
      [
        { text: 'Okay' },
      ],
    ...
    // AlertDialog(
    //   'Welcome!',
    //   `Today is ${day}, and that means all your activated powerups last
    //   twice as long.`,
    //   [
    //     { text: 'Okay' },
    //   ],
